...
import com.fredericho.data.source.UsersDataSource.daniel
import com.fredericho.data.source.UsersDataSource.duaLipa
import com.fredericho.data.source.UsersDataSource.google
import com.fredericho.data.source.UsersDataSource.imagineDragons
import com.fredericho.data.source.UsersDataSource.jeremy
import com.fredericho.data.source.UsersDataSource.kylieJenner
import com.fredericho.data.source.UsersDataSource.shana
import com.fredericho.data.source.UsersDataSource.taylor
import com.fredericho.data.source.UsersDataSource.zoya
...
object VideoDataSource {
    ...
    fun fetchVideos() : Flow<List<VideoModel>> {
        return flow { emit(videosList.shuffled()) }
    }
