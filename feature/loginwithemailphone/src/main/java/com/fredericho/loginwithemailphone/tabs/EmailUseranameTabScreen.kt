...
import com.fredericho.loginwithemailphone.suggestedDomainList
...
fun EmailUsernameTabScreen(
    ...
    Column(
        ...
        Column(
            ...
            EmailField(email = email, viewModel = viewModel)
            8.dp.Space()
            PrivacyPolicyText(onClickAnnotation = {})
            16.dp.Space()
            CustomButton(
                buttonText = stringResource(id = com.fredericho.theme.R.string.next),
        ...
        DomainSuggestion(onClickDomain = {
...
fun EmailField(email: Pair<String, String?>, viewModel: LoginWithEmailPhoneViewModel) {
    ...
    TextField(
        ...
        placeholder = {
            Text(
                text = stringResource(id = com.fredericho.theme.R.string.enter_email_address_or_username),
...
fun PrivacyPolicyText(onClickAnnotation: (String) -> Unit) {
    val annotatedString = buildAnnotatedString {
        append(stringResource(id = com.fredericho.theme.R.string.by_continuing_you_agree))
        ...
        ) { append(" ${stringResource(id = com.fredericho.theme.R.string.terms_of_service)}") }
        pop()

        append(stringResource(id = com.fredericho.theme.R.string.and_confirm_that_you_have_read))
        ...
        ) { append(" ${stringResource(id = com.fredericho.theme.R.string.privacy_policy)}") }
        pop()
    }
