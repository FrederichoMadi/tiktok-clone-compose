...
import com.fredericho.composable.CustomIconButton
import com.fredericho.core.AppContract.Annotate.ANNOTATED_PRIVACY_POLICY
import com.fredericho.core.AppContract.Annotate.ANNOTATED_TAG
import com.fredericho.core.AppContract.Annotate.ANNOTATED_TERMS_OF_SERVICE
import com.fredericho.core.DestinationRoute.LOGIN_OR_SIGNUP_WITH_PHONE_EMAIL_ROUTE
...
internal fun AuthenticationButton(onClickButton: (LoginOption) -> Unit) {
    LoginOption.values().asList().forEach {
        CustomIconButton(
            ...
            iconTint = if(it.icon == R.drawable.ic_profile) it.contentColor else Color.Unspecified
        ) {
            onClickButton(it)
        }
        12.dp.Space()
...
fun PrivacyPolicyFooter() {
    ...
    val annotatedString = buildAnnotatedString {
        ...
        withStyle(
            ...
            append(stringResource(id = R.string.terms_and_policies))
        }
        pop()
