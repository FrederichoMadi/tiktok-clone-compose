...
import com.fredericho.core.utils.FileUtils
import com.fredericho.data.model.VideoModel
import com.fredericho.theme.GrayMainColor
...
fun VideoGrid(
    ...
    LazyVerticalGrid(
        ...
        itemsIndexed(videoList) {index, item ->
            context.VideoGridItem(item = item, index = index, onClickVideo = onClickVideo)
        }
    }
}
...
fun Context.VideoGridItem(
    ...
    Box(
        ...
        Row(
            ...
            Icon(
                painterResource(id = com.fredericho.theme.R.drawable.ic_play_outline),
                contentDescription = null,
