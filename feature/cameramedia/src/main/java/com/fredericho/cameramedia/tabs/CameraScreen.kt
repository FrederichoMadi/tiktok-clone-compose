...
import com.fredericho.cameramedia.CameraCaptureOptions
import com.fredericho.cameramedia.CameraController
import com.fredericho.cameramedia.CameraMediaViewModel
import com.fredericho.cameramedia.PermissionType
import com.fredericho.cameramedia.R
import com.fredericho.cameramedia.Tabs
import com.fredericho.composable.CaptureButton
import com.fredericho.core.extension.MediumSpace
import com.fredericho.core.extension.Space
import com.fredericho.core.utils.openAppSetting
import com.fredericho.theme.LightGreenColor
import com.fredericho.theme.TealColor
...
fun CameraScreen(
    ...
    Column(
        ...
        if (multiplePermissionState.permissions[0].status.isGranted) {
            CameraPreview(cameraOpenType = cameraOpenType, onClickCancel = { }) {
                fileLauncher.launch(pickVisualMediaRequest)
            }
        } else {
            CameraMicrophoneAccessPage(
                isMicrophonePermissionGranted = multiplePermissionState.permissions[1].status.isGranted,
...
fun CameraMicrophoneAccessPage(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = com.fredericho.theme.R.string.allow_tiktok_to_access_your),
        ...
        Text(
            text = "${stringResource(id = com.fredericho.theme.R.string.take_photos_record_videos_or_preview)} ${
                stringResource(id = com.fredericho.theme.R.string.you_can_change_preference_in_setting)
            }",
            textAlign = TextAlign.Center,
            modifier = Modifier.fillMaxWidth(0.75f),
        ...
        Card(
            ...
            Column(
                ...
                Row(
                    ...
                    Icon(
                        painter = painterResource(id = com.fredericho.theme.R.drawable.ic_camera),
                        contentDescription = null,
                    )
                    Text(
                        text = stringResource(id = com.fredericho.theme.R.string.access_camera),
                ...
                if (!isMicrophonePermissionGranted) {
                    ...
                    Row(
                        ...
                        Icon(
                            painter = painterResource(id = com.fredericho.theme.R.drawable.ic_microphone),
                            contentDescription = null,
                        )
                        Text(
                            text = stringResource(id = com.fredericho.theme.R.string.access_microhpone),
                            style = MaterialTheme.typography.bodyMedium,
                        )
                    }
                }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Box(
            ...
            Row(
                ...
                Icon(
                    painterResource(id = com.fredericho.theme.R.drawable.ic_music_note),
                    contentDescription = null,
                    modifier = Modifier.size(18.dp)
                )
                Text(
                    text = stringResource(id = com.fredericho.theme.R.string.add_sound),
    ...
    Column(
        ...
        Row(
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = com.fredericho.theme.R.drawable.img_effect_placeholder),
                    contentDescription = null,
                    modifier = Modifier
                        .alpha(alphaForInteractiveView(isEnabledLayout))
                        .size(32.dp)
                ...
                Text(
                    text = stringResource(id = com.fredericho.theme.R.string.effects),
            ...
            val captureButtonColor =
                when (captureOptions.getOrNull(layoutInfo.currentItem?.index ?: -1)) {
                    CameraCaptureOptions.FIFTEEN_SECOND,
                    CameraCaptureOptions.SIXTY_SECOND,
                    CameraCaptureOptions.VIDEO -> MaterialTheme.colorScheme.primary
            ...
            Column(
                ...
                Text(
                    text = stringResource(id = com.fredericho.theme.R.string.upload),
                    style = MaterialTheme.typography.labelMedium,
                )
            }
...
fun CameraSideControllerSection(
    ...
    val controllers =
        if (defaultCameraFacing == CameraSelector.DEFAULT_BACK_CAMERA) CameraController.values()
            .toMutableList()
            .apply { remove(CameraController.MIRROR) } else CameraController.values()
            .toMutableList()
            .apply { remove(CameraController.FLASH) }
    ...
    Column(
        ...
        controllers.forEach {
            ControllerItem(cameraController = it, onClickController = onClickController)
        }
    }
}
...
fun ControllerItem(
    ...
    Column(
        ...
        Icon(
            painter = painterResource(id = cameraController.icon),
            contentDescription = null,
...
fun alphaForInteractiveView(isEnabledLayout: Boolean): Float =
    if (isEnabledLayout) 1f else 0.28f